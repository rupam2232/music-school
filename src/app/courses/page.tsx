...
const page = () => {
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-black py-12 pt-36">
      <h1 className="text-lg md:text-7xl text-center font-sans font-bold mb-8 dark:text-white">All courses ({courseData.courses.length})</h1>
